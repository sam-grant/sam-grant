...
- [RadialField](https://github.com/sam-grant/RadialField): analysis code for estimating the size of radial magentic field in the Fermilab $g-2$ storage ring based. Code relating to direct radial field measurements can be found in [EDM](https://github.com/sam-grant/EDM). 
